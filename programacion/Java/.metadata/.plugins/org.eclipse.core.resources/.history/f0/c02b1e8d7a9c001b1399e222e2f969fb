...
public static void menu() {//Menu de inicio con la funcion de salir
		...
		private static int tipoCongelado(){//mensaje que muestra el menu para el cliente
		    ...
		    tipo= JOptionPane.showOptionDialog(null,"¿Que tipo de regrigeración tiene el producto?" , "Menu" , JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null, opciones, null);
		    return tipo;
