...
public class PrestamoPersonal extends Prestamo {
	...
	public void calcularPrestamo()
	{
		...
		System.out.println("interes mensual= "+(super.getInteresAnual() / 100) / 12);
		System.out.println("interes coutamensual= "+(float) ((super.getCapital() * this.interesMensual) / (1 - Math.pow(1 + this.interesMensual, -1 * 12 * super.getPlazo()))));
		System.out.println((super.getPlazo() * 12 * this.cuotaMensual) - super.getCapital());
	}
